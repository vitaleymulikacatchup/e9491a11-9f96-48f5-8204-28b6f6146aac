...
export const metadata: Metadata = {
  title: "Premium Cars - Luxury Vehicle Dealership",
  description: "Discover premium luxury vehicles with lifetime warranty and exceptional service. Browse our collection of handpicked cars and schedule your test drive today.",
  keywords: "luxury cars, vehicle dealership, premium automobiles, car sales, automotive",
  metadataBase: new URL("https://premiumcars.com"),
  alternates: {
    canonical: "https://premiumcars.com"
  },
  openGraph: {
    title: "Premium Cars - Luxury Vehicle Dealership",
    description: "Discover premium luxury vehicles with lifetime warranty and exceptional service",
    url: "https://premiumcars.com",
    siteName: "Premium Cars",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765887213777-pudbel2m.jpg",
  ...
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765887213777-pudbel2m.jpg"]
  },
  robots: {
    index: true,
    follow: true
